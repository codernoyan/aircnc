        ...
        <div className='flex justify-between'>
          <div className='shadow-md rounded-md my-2 p-3 flex justify-between items-center'>
            <div>
              ...
              <DatePicker selected={arrivalDate} className='w-2/3' onChange={(date) => setArrivalDate(date)} />
            </div>
          ...
          <div className='shadow-md rounded-md my-2 p-3 flex justify-between items-center'>
            <div>
              ...
              <DatePicker selected={departureDate} className='w-2/3' onChange={(date)=> setDepartureDate(date)} />
            </div>
